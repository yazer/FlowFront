...
const MultiLineTextArea: FC<TextFieldInterface> = ({
  collapse,
  onChange,
  name,
  formElement,
  ...
  const [data, setData] = useState({
    ...
    name: name || "",
    element_type: elements_type.MULTILINETEXTFIELD,
      ...
      {isExpanded && (
        <div className="p-4 space-y-6">
          ...
          <Dropdown
            ...
            onChange={(e) => updateData("rows", e.target.value, true)}
            value={data?.rows}
          />
          ...
          <AdvancedOptionsWrapper>
            ...
            {data?.enableValidation && (
              <div className="space-y-4">
                {data.input_type === "number" || data.input_type === "float" ? (
                  <>
                    <InputField
